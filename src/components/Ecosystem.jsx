                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="nfts-contents">
                                        ...
                                        <ul className="d-flex align-items-center action-btns">
                                            <li><a href="# " className="btn">Claim</a></li>
                                            <li><a href="# " className="btn">Stake</a></li>
                                            <li><a href="# " className="btn">Battlepass</a></li>
                                        </ul>
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="nfts-contents">
                                        ...
                                        <ul className="d-flex align-items-center action-btns">
                                            ...
                                            <li><a href="# " className="btn">Buy NFTs</a></li>
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="nfts-contents mt-170">
                                        ...
                                        <ul className="d-flex align-items-center">
                                            ...
                                            <li><a href="# " className="btn">Mint Page</a></li>
