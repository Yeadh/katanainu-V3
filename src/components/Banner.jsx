        ...
        <>
          ...
          <section className="banner-area">
            ...
            <div className="banner-bg">
              <video src="assets/img/banner/video_6.mp4" autoPlay muted loop></video>
            </div>
              ...
              <Slider {...settings}>
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="banner-content">
                        <img src="assets/img/banner/banner_text.png" alt="KatanaInu" className="heading-text wow fadeInDown" data-wow-delay=".2s" data-animation="fadeInDown"/>
                ...
                <div className="col">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div className="banner-img">
                        {/* <img src="assets/img/banner/Ki.gif" alt="img" /> */}
                      </div>
                    </div>
                  </div>
                  {/* <div className="banner-social">
                ...
                <div className="col">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <div className="banner-img">
                        {/* <img src="assets/img/banner/BC.gif" alt="img" /> */}
                      </div>
                    </div>
                  </div>
                  {/* <div className="banner-social">
