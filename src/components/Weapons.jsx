        ...
        <div className="weapons-area">
            ...
            <div className="weapon-bottom-button">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="banner-btn-wrap mt-10">
                                <div className="wow fadeInLeft" data-wow-delay=".8s" data-animation="fadeInLeft"><a href="https://mint.katanainu.com/" target="_blank" rel="noreferrer" className="btn">Mint now NFTs</a></div>
